...
$appVersionLabel = "v0.2.7 Dispatch, Return, and Payable Read Foundation"
$routeSmokeCount = 0
...
try {
    ...
    if ($versionResponse.Content -notmatch "v0\.2\.7") {
        Fail "Version check failed: /version does not contain v0.2.7." "Version" "/version" "Update config/app.php and VersionController so /version displays v0.2.7."
    }
    Ok "Version"
