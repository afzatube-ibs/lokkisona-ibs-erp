...
$appVersionLabel = "v0.2.4 Product and Variant Read Foundation"
$routeSmokeCount = 0
...
try {
    ...
    if ($versionResponse.Content -notmatch "v0\.2\.4") {
        Fail "Version check failed: /version does not contain v0.2.4." "Version" "/version" "Update config/app.php and VersionController so /version displays v0.2.4."
    }
    Ok "Version"
