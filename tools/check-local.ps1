...
$appVersionLabel = "v0.2.3 Supplier and Business Source Read Foundation"
$routeSmokeCount = 0
...
try {
    ...
    if ($versionResponse.Content -notmatch "v0\.2\.3") {
        Fail "Version check failed: /version does not contain v0.2.3." "Version" "/version" "Update config/app.php and VersionController so /version displays v0.2.3."
    }
    Ok "Version"
