...
$router->post('/sync-api-settings/save-entry-mappings', 'SyncApiSettingsController@saveEntryMappings');
$router->post('/sync-api-settings/save-final-result-mappings', 'SyncApiSettingsController@saveFinalResultMappings');
$router->post('/sync-api-settings/preview-products', 'SyncApiSettingsController@previewProducts');
$router->post('/sync-api-settings/import-products', 'SyncApiSettingsController@importProducts');
$router->post('/sync-api-settings/run-order-preview', 'SyncApiSettingsController@runOrderPreview');
$router->post('/sync-api-settings/import-orders', 'SyncApiSettingsController@importOrders');
$router->post('/sync-api-settings/reset/clear-product-preview', 'SyncApiSettingsController@resetClearProductPreview');
$router->post('/sync-api-settings/reset/product-data', 'SyncApiSettingsController@resetProductData');
$router->post('/sync-api-settings/reset/clear-order-preview', 'SyncApiSettingsController@resetClearOrderPreview');
$router->post('/sync-api-settings/reset/demo-orders', 'SyncApiSettingsController@resetDemoOrders');
$router->post('/sync-api-settings/reset/entry-mappings', 'SyncApiSettingsController@resetEntryMappings');
$router->post('/sync-api-settings/reset/final-result-mappings', 'SyncApiSettingsController@resetFinalResultMappings');
