...
<div class="card" style="margin-bottom:1.5rem;">
    ...
    <div class="card-body">
        <form method="post" action="<?= e(url('/manual-orders/create')) ?>" id="manualOrderForm" class="manual-order-form">
            <?= $csrfField ?? '' ?>
            ...
            <button type="submit" class="btn btn-primary" style="margin-top:0.75rem;">Create Manual Order</button>
        </form>
    </div>
</div>
