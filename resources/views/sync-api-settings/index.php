...
<div>
    ...
    <div class="sync-hub-layout">
        ...
        <div class="sync-hub-content">
            ...
            <div class="sync-hub-mapping-hint mb-15 sync-hub-mapping-alert" data-sync-hub-alert-tabs="mapping,products,orders" hidden>
                Set at least one OpenCart queue status to &ldquo;Import as New&rdquo; before order sync.
            </div>
            <?php endif; ?>
