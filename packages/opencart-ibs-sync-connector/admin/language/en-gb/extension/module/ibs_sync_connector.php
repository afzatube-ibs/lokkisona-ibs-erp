...
$_['text_queue_help']  = 'Only orders in these OpenCart statuses are returned to IBS ERP. IBS maps each queue status to an SFM workflow status in Sync Settings.';
...
$_['help_endpoints']    = 'Catalog API routes (append api_token): connection_test, version, products, order_queue_statuses, orders.';
