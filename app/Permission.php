...
class Permission
{
    ...
    public static function menuItems()
    {
        $items = [
            ...
            ['label' => 'Sync/API Settings', 'path' => '/sync-api-settings', 'permission' => 'sync_api_settings.view', 'tier' => 'system', 'group' => 'System', 'icon' => '<circle cx="12" cy="12" r="3"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/>'],
