    ...
    private function buildVersionInfo()
    {
        return [
            ...
            'features' => [
                ...
                'New metadata-only App\\Models\\BaseModel with read-only table(), columns(), and primaryKey() accessors and no PDO, query, save, find, create, update, delete, or schema logic',
