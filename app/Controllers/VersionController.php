    ...
    private function buildVersionInfo()
    {
        return [
            ...
            'features' => [
                ...
                'Suppliers, Business Sources, Product Control, and Supplier Opening Balances pages note that read-only repositories are prepared but planning data is still shown only',
