...
class VersionController extends Controller
{
    ...
    private function buildVersionInfo()
    {
        return [
            ...
            'features' => [
                'Supplier and Business Source Read Foundation: /suppliers and /business-sources now wire SupplierReadService and BusinessSourceReadService with graceful empty states when MySQL or tables are unavailable',
                ...
                'Suppliers and Business Sources pages show live read-only inventory; Product Control and Supplier Opening Balances still show planning data only',
