...
class DispatchStatementLinePresenter
{
    ...
    public static function build(
        ...
        foreach ($items as $item) {
            ...
            $courierStatus = trim((string) ($item['courier_status'] ?? '')) ?: '—';
            $consignmentId = trim((string) ($item['tracking_number'] ?? '')) ?: 'Not Assigned';
            $invoicePrintUrl = $orderId > 0
                ? url('/invoice-printing?order_ids=' . $orderId)
                : null;
            ...
            foreach ($formattedLines as $line) {
                ...
                $productRows[] = [
                    ...
                    'invoice_print_url' => $invoicePrintUrl,
